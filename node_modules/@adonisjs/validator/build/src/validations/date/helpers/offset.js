...
import { isRef, enforceDateTime } from '../../../validator/helpers.js';
/**
 ...
 */
export function compile(ruleName, operator, [duration, unit]) {
    /**
 ...
 */
export function validate(ruleName, errorMessage, value, compiledOptions, { errorReporter, pointer, arrayExpressionPointer, refs }) {
    let comparisonDate;
    /**
    ...
    enforceDateTime(comparisonDate, `"${ruleName}": expects "refs.${compiledOptions.ref}" to be an instance of luxon DateTime object`);
