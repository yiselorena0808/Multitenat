...
import { isObject, wrapCompile } from '../../validator/helpers.js';
...
export const email = {
    ...
    validate(value, compiledOptions, { errorReporter, arrayExpressionPointer, pointer, mutate }) {
         ...
         * Invalid email
         */
        if (!validatorJs.default.isEmail(value, compiledOptions)) {
        ...
        if (isObject(compiledOptions.sanitize)) {
            mutate(validatorJs.default.normalizeEmail(value, compiledOptions.sanitize));
        }
    },
};
