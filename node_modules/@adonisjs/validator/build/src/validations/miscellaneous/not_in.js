 ...
 */
export const notIn = {
    compile: wrapCompile(RULE_NAME, ['string', 'number', 'array', 'date'], ([values], _, subtype) => {
        /**
    ...
    validate(value, compiledOptions, { errorReporter, pointer, arrayExpressionPointer, refs }) {
        ...
        if (compiledOptions.ref) {
            ...
            enforceArray(runtimevalues, `"${RULE_NAME}": expects "refs.${compiledOptions.ref}" to be an array`);
