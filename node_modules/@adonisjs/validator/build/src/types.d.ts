 ...
 */
export type SyncValidation<T extends any = unknown, SubType extends NodeSubType = NodeSubType> = {
    compile(type: NodeType, subtype: SubType, options?: any, rulesTree?: {
        [key: string]: any;
    }): ParsedRule<T>;
 ...
 * repoter
 */
export type RequestNegotiator = (request: Request) => ErrorReporterConstructorContract;
/**
 * A callback method to return default messages for validation.
 */
export type DefaultMessagesCallback = (ctx?: HttpContext) => CustomMessages;
/**
 ...
 */
export type RequestValidatorNode<T extends ParsedTypedSchema<TypedSchema>> = (new (ctx: HttpContext) => WithOptional<ValidatorNode<T>, 'data'>) | WithOptional<ValidatorNode<T>, 'data'>;
/**
