...
import type { NodeType, SchemaRef, ParsedRule, NodeSubType, ErrorReporterConstructorContract } from '../types.js';
 ...
 */
export declare function wrapCompile<T extends any, SubType extends NodeSubType = NodeSubType>(name: string, restrictForTypes?: SubType[], customCallback?: (options: any[], type: NodeType, subtype: SubType, rulesTree: any) => Partial<ParsedRule<T>>): (type: NodeType, subtype: SubType, options: T, rulesTree: any) => ParsedRule<T>;
/**
